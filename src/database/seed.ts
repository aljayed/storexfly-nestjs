...
const PRODUCTS: {
  ...
  { name: 'Alphonso Mango Box', cat: 'Mangoes', price: 38, unit: 'box of 12', stock: 46, emoji: '🥭', tone: '#fbeede', tag: 'Bestseller', rating: 4.9, reviews: 312, blurb: 'The king of mangoes — buttery, fragrant Ratnagiri Alphonsos, hand-picked and ripened naturally.',
    highlights: [
      { icon: 'truck', title: 'Free next-day', subtitle: 'Cold-chain delivery' },
      { icon: 'zap', title: 'Ripe guarantee', subtitle: 'Or we replace it free' },
      { icon: 'package', title: 'Hand-packed', subtitle: 'Picked same morning' },
    ] },
  { name: 'Kesar Mango Box', cat: 'Mangoes', price: 32, unit: 'box of 12', stock: 30, emoji: '🥭', tone: '#f8eed5', tag: 'In season', rating: 4.8, reviews: 188, blurb: 'Saffron-hued Gir Kesar mangoes with a rich, honeyed sweetness.' },
  { name: 'Mango Gift Hamper', cat: 'Gifting', price: 64, unit: 'hamper', stock: 18, emoji: '🎁', tone: '#f6dfc2', tag: 'Gift', rating: 5.0, reviews: 74, blurb: 'A premium hamper: 6 Alphonsos, mango pulp, dried slices & a handwritten note.' },
  { name: 'Fresh Lychees', cat: 'Fruits', price: 14, unit: '500g', stock: 52, emoji: '🍇', tone: '#f7e2dd', rating: 4.7, reviews: 96, blurb: 'Juicy, floral lychees picked at peak ripeness.' },
  { name: 'Tender Coconut', cat: 'Fruits', price: 6, unit: 'each', stock: 120, emoji: '🥥', tone: '#eef0ea', rating: 4.6, reviews: 140, blurb: 'Chilled tender coconuts, full of sweet water.' },
  { name: 'Custard Apple', cat: 'Fruits', price: 11, unit: '4 pcs', stock: 0, emoji: '🍏', tone: '#e2f1e8', rating: 4.5, reviews: 58, blurb: 'Creamy sitaphal, naturally sweet — back soon.' },
  { name: 'Dried Mango Slices', cat: 'Pantry', price: 9, unit: '200g pack', stock: 88, emoji: '🍯', tone: '#f8eed5', tag: 'Snack', rating: 4.8, reviews: 210, blurb: 'Chewy, no-sugar-added dried Alphonso slices.' },
  { name: 'Mango Pulp Tin', cat: 'Pantry', price: 8, unit: '850g tin', stock: 64, emoji: '🥫', tone: '#fbeede', rating: 4.7, reviews: 133, blurb: 'Smooth sweetened Alphonso pulp for shakes & desserts.' },
  { name: 'Mango Pickle', cat: 'Pantry', price: 7, unit: '400g jar', stock: 41, emoji: '🫙', tone: '#f7e2dd', rating: 4.6, reviews: 87, blurb: 'Tangy, spicy raw-mango pickle, made in small batches.' },
  { name: 'Banganapalli Mango', cat: 'Mangoes', price: 28, unit: 'box of 12', stock: 24, emoji: '🥭', tone: '#f8eed5', rating: 4.5, reviews: 64, blurb: 'Large, firm, mildly sweet — great for slicing.' },
  { name: 'Seasonal Fruit Basket', cat: 'Gifting', price: 42, unit: 'basket', stock: 15, emoji: '🧺', tone: '#eef0ea', tag: 'Gift', rating: 4.9, reviews: 51, blurb: "A curated basket of whatever's freshest this week." },
  { name: 'Mango Lassi Kit', cat: 'Pantry', price: 16, unit: 'makes 6', stock: 33, emoji: '🥛', tone: '#fbeede', tag: 'New', rating: 4.8, reviews: 29, blurb: 'Everything you need for café-style mango lassi at home.' },
];
  ...
  try {
    ...
    for (const p of PRODUCTS) {
      const [row] = await db
        ...
        .returning({ id: schema.products.id, priceCents: schema.products.priceCents });
